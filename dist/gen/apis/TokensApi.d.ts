...
import type { Network, TokenMeta } from '../models/index';
...
export declare class TokensApi extends runtime.BaseAPI {
     ...
     */
    listTokensRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TokenMeta>>>;
    /**
     * Get Faraday supported tokens
     */
    listTokens(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TokenMeta>>;
    /**
     * Get Faraday supported tokens by network
     */
    listTokensByNetworkRaw(requestParameters: ListTokensByNetworkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TokenMeta>>>;
    /**
     * Get Faraday supported tokens by network
     */
    listTokensByNetwork(requestParameters: ListTokensByNetworkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TokenMeta>>;
}
