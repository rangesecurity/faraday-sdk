...
import type { NetworkInfo } from '../models/index';
/**
 *
 */
export declare class ChainsApi extends runtime.BaseAPI {
     ...
     */
    listNetworksRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NetworkInfo>>>;
    /**
     *  Returns an array of all blockchain networks supported by the Faraday API.  Each object in the response describes one supported network and includes: - `slug`: canonical short identifier for the chain - `label`: human-readable display name - `kind`: network family (`evm`, `solana`, or `cosmos`) - `aliases`: alternative strings accepted in API requests  > **Note:** You may use either the `slug` or one of its `aliases` as the value for > `from_chain` or `to_chain` when submitting quote or transaction requests.  This endpoint does not require authentication.
     */
    listNetworks(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NetworkInfo>>;
}
//# sourceMappingURL=ChainsApi.d.ts.map