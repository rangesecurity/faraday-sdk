...
import { QuoteWithRiskFromJSON, QuotesWithRiskFromJSON, SubmitTransactionRequestToJSON, SubmitTransactionResponseFromJSON, TransactionReportFromJSON, } from '../models/index';
/**
 *
 */
export class TransactionsApi extends runtime.BaseAPI {
    ...
    async getQuoteRaw(requestParameters, initOverrides) {
        if (requestParameters['fromChain'] == null) {
            throw new runtime.RequiredError('fromChain', 'Required parameter "fromChain" was null or undefined when calling getQuote().');
        }
        if (requestParameters['fromAddress'] == null) {
            throw new runtime.RequiredError('fromAddress', 'Required parameter "fromAddress" was null or undefined when calling getQuote().');
        }
        if (requestParameters['fromAsset'] == null) {
            throw new runtime.RequiredError('fromAsset', 'Required parameter "fromAsset" was null or undefined when calling getQuote().');
        }
        if (requestParameters['toChain'] == null) {
            throw new runtime.RequiredError('toChain', 'Required parameter "toChain" was null or undefined when calling getQuote().');
        }
        if (requestParameters['toAsset'] == null) {
            throw new runtime.RequiredError('toAsset', 'Required parameter "toAsset" was null or undefined when calling getQuote().');
        }
        if (requestParameters['amount'] == null) {
            throw new runtime.RequiredError('amount', 'Required parameter "amount" was null or undefined when calling getQuote().');
        }
        if (requestParameters['slippageBps'] == null) {
            throw new runtime.RequiredError('slippageBps', 'Required parameter "slippageBps" was null or undefined when calling getQuote().');
        }
        if (requestParameters['toAddress'] == null) {
            throw new runtime.RequiredError('toAddress', 'Required parameter "toAddress" was null or undefined when calling getQuote().');
        }
     ...
     */
    async getQuotesRaw(requestParameters, initOverrides) {
        if (requestParameters['fromChain'] == null) {
            throw new runtime.RequiredError('fromChain', 'Required parameter "fromChain" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['fromAddress'] == null) {
            throw new runtime.RequiredError('fromAddress', 'Required parameter "fromAddress" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['fromAsset'] == null) {
            throw new runtime.RequiredError('fromAsset', 'Required parameter "fromAsset" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['toChain'] == null) {
            throw new runtime.RequiredError('toChain', 'Required parameter "toChain" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['toAsset'] == null) {
            throw new runtime.RequiredError('toAsset', 'Required parameter "toAsset" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['amount'] == null) {
            throw new runtime.RequiredError('amount', 'Required parameter "amount" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['slippageBps'] == null) {
            throw new runtime.RequiredError('slippageBps', 'Required parameter "slippageBps" was null or undefined when calling getQuotes().');
        }
        if (requestParameters['toAddress'] == null) {
            throw new runtime.RequiredError('toAddress', 'Required parameter "toAddress" was null or undefined when calling getQuotes().');
        }
        const queryParameters = {};
        if (requestParameters['fromChain'] != null) {
            queryParameters['from_chain'] = requestParameters['fromChain'];
     ...
     * Get all available quotes for a stablecoin transfer
     */
    async getQuotes(requestParameters, initOverrides) {
     ...
     * Get a transaction
     */
    async getTransactionByHashRaw(requestParameters, initOverrides) {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling getTransactionByHash().');
        }
        const queryParameters = {};
        const headerParameters = {};
        if (this.configuration && this.configuration.accessToken) {
     ...
     * Get a transaction
     */
    async getTransactionByHash(requestParameters, initOverrides) {
     ...
     */
    async getTransactionsRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (this.configuration && this.configuration.accessToken) {
            const token = this.configuration.accessToken;
     ...
     * List transactions for the authenticated user
     */
    async getTransactions(initOverrides) {
     ...
     */
    async postTransactionRaw(requestParameters, initOverrides) {
        if (requestParameters['submitTransactionRequest'] == null) {
            throw new runtime.RequiredError('submitTransactionRequest', 'Required parameter "submitTransactionRequest" was null or undefined when calling postTransaction().');
        }
        const queryParameters = {};
        const headerParameters = {};
     ...
     * Submit a signed transaction
     */
    async postTransaction(requestParameters, initOverrides) {
