...
import { TokenMetaFromJSON, } from '../models/index';
/**
 *
 */
export class TokensApi extends runtime.BaseAPI {
     ...
     */
    async listTokensRaw(initOverrides) {
     ...
     * Get Faraday supported tokens
     */
    async listTokens(initOverrides) {
     ...
     */
    async listTokensByNetworkRaw(requestParameters, initOverrides) {
        if (requestParameters['network'] == null) {
            throw new runtime.RequiredError('network', 'Required parameter "network" was null or undefined when calling listTokensByNetwork().');
        }
        const queryParameters = {};
        const headerParameters = {};
        if (this.configuration && this.configuration.accessToken) {
     ...
     * Get Faraday supported tokens by network
     */
    async listTokensByNetwork(requestParameters, initOverrides) {
