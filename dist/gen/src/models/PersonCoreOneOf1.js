 ...
 */
import { PersonCoreOneOf1PersonFromJSON, PersonCoreOneOf1PersonToJSON, } from './PersonCoreOneOf1Person';
/**
 * @export
 */
 ...
 */
export function instanceOfPersonCoreOneOf1(value) {
...
export function PersonCoreOneOf1FromJSON(json) {
    return PersonCoreOneOf1FromJSONTyped(json, false);
}
export function PersonCoreOneOf1FromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PersonCoreOneOf1ToJSON(json) {
    return PersonCoreOneOf1ToJSONTyped(json, false);
}
export function PersonCoreOneOf1ToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
