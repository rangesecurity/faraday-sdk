 ...
 */
import { RouteQuoteFromJSON, RouteQuoteToJSON, } from './RouteQuote';
/**
 * Check if a given object implements the QuotesWithRisk interface.
 */
export function instanceOfQuotesWithRisk(value) {
    if (!('quotes' in value) || value['quotes'] === undefined)
        return false;
    if (!('risk' in value) || value['risk'] === undefined)
        return false;
    return true;
}
export function QuotesWithRiskFromJSON(json) {
    return QuotesWithRiskFromJSONTyped(json, false);
}
export function QuotesWithRiskFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        'quotes': (json['quotes'].map(RouteQuoteFromJSON)),
        'risk': json['risk'],
    };
}
export function QuotesWithRiskToJSON(json) {
    return QuotesWithRiskToJSONTyped(json, false);
}
export function QuotesWithRiskToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        'quotes': (value['quotes'].map(RouteQuoteToJSON)),
        'risk': value['risk'],
    };
}
