 ...
 */
import { PersonFromJSON, PersonToJSON, } from './Person';
/**
 * Check if a given object implements the TransactionReport interface.
 */
export function instanceOfTransactionReport(value) {
    ...
    if (!('network' in value) || value['network'] === undefined)
        return false;
    if (!('travel_rule_compliant' in value) || value['travel_rule_compliant'] === undefined)
        return false;
    if (!('tx_hash' in value) || value['tx_hash'] === undefined)
        return false;
    return true;
}
export function TransactionReportFromJSON(json) {
    return TransactionReportFromJSONTyped(json, false);
}
export function TransactionReportFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TransactionReportToJSON(json) {
    return TransactionReportToJSONTyped(json, false);
}
export function TransactionReportToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
