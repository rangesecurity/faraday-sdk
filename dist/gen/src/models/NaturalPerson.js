 ...
 */
export function instanceOfNaturalPerson(value) {
    return true;
}
export function NaturalPersonFromJSON(json) {
    return NaturalPersonFromJSONTyped(json, false);
}
export function NaturalPersonFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NaturalPersonToJSON(json) {
    return NaturalPersonToJSONTyped(json, false);
}
export function NaturalPersonToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
