...
export function ChainKindFromJSON(json) {
    return ChainKindFromJSONTyped(json, false);
}
export function ChainKindFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function ChainKindToJSON(value) {
    return value;
}
export function ChainKindToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
