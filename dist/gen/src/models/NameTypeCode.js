...
export function NameTypeCodeFromJSON(json) {
    return NameTypeCodeFromJSONTyped(json, false);
}
export function NameTypeCodeFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function NameTypeCodeToJSON(value) {
    return value;
}
export function NameTypeCodeToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
