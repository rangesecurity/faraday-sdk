 ...
 */
export function instanceOfAccountNumber(value) {
    return true;
}
export function AccountNumberFromJSON(json) {
    return AccountNumberFromJSONTyped(json, false);
}
export function AccountNumberFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountNumberToJSON(json) {
    return AccountNumberToJSONTyped(json, false);
}
export function AccountNumberToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
