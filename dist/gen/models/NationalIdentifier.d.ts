 ...
 */
export declare function instanceOfNationalIdentifier(value: object): value is NationalIdentifier;
export declare function NationalIdentifierFromJSON(json: any): NationalIdentifier;
export declare function NationalIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): NationalIdentifier;
export declare function NationalIdentifierToJSON(json: any): NationalIdentifier;
export declare function NationalIdentifierToJSONTyped(value?: NationalIdentifier | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=NationalIdentifier.d.ts.map