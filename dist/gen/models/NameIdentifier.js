 ...
 */
import { NameTypeCodeFromJSON, NameTypeCodeToJSON, } from './NameTypeCode';
/**
 * Check if a given object implements the NameIdentifier interface.
 */
export function instanceOfNameIdentifier(value) {
    return true;
}
export function NameIdentifierFromJSON(json) {
    return NameIdentifierFromJSONTyped(json, false);
}
export function NameIdentifierFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NameIdentifierToJSON(json) {
    return NameIdentifierToJSONTyped(json, false);
}
export function NameIdentifierToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
