...
export declare function instanceOfAddressType(value: any): boolean;
...
export declare function AddressTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): AddressType;
