 ...
 */
import { instanceOfPersonCoreOneOf, PersonCoreOneOfFromJSONTyped, PersonCoreOneOfToJSON, } from './PersonCoreOneOf';
import { instanceOfPersonCoreOneOf1, PersonCoreOneOf1FromJSONTyped, PersonCoreOneOf1ToJSON, } from './PersonCoreOneOf1';
export function PersonCoreFromJSON(json) {
    return PersonCoreFromJSONTyped(json, false);
}
export function PersonCoreFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
...
export function PersonCoreToJSON(json) {
    return PersonCoreToJSONTyped(json, false);
}
export function PersonCoreToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfPersonCoreOneOf(value)) {
        return PersonCoreOneOfToJSON(value);
    }
    if (instanceOfPersonCoreOneOf1(value)) {
        return PersonCoreOneOf1ToJSON(value);
    }
    return {};
}
