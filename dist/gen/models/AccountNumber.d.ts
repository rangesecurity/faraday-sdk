 ...
 */
export declare function instanceOfAccountNumber(value: object): value is AccountNumber;
export declare function AccountNumberFromJSON(json: any): AccountNumber;
export declare function AccountNumberFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountNumber;
export declare function AccountNumberToJSON(json: any): AccountNumber;
export declare function AccountNumberToJSONTyped(value?: AccountNumber | null, ignoreDiscriminator?: boolean): any;
