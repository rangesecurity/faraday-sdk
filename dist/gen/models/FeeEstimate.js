 ...
 */
export function instanceOfFeeEstimate(value) {
    if (!('fee_asset' in value) || value['fee_asset'] === undefined)
        return false;
    if (!('network_fee' in value) || value['network_fee'] === undefined)
        return false;
    if (!('router_fee' in value) || value['router_fee'] === undefined)
        return false;
    if (!('total_fee' in value) || value['total_fee'] === undefined)
        return false;
    return true;
}
export function FeeEstimateFromJSON(json) {
    return FeeEstimateFromJSONTyped(json, false);
}
export function FeeEstimateFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function FeeEstimateToJSON(json) {
    return FeeEstimateToJSONTyped(json, false);
}
export function FeeEstimateToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
