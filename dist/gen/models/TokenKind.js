...
export function TokenKindFromJSON(json) {
    return TokenKindFromJSONTyped(json, false);
}
export function TokenKindFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function TokenKindToJSON(value) {
    return value;
}
export function TokenKindToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
