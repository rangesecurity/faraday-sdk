 ...
 */
export function instanceOfLegalPerson(value) {
    return true;
}
export function LegalPersonFromJSON(json) {
    return LegalPersonFromJSONTyped(json, false);
}
export function LegalPersonFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function LegalPersonToJSON(json) {
    return LegalPersonToJSONTyped(json, false);
}
export function LegalPersonToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
