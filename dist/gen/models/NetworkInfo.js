 ...
 */
import { ChainKindFromJSON, ChainKindToJSON, } from './ChainKind';
/**
 * Check if a given object implements the NetworkInfo interface.
 */
export function instanceOfNetworkInfo(value) {
...
export function NetworkInfoFromJSON(json) {
    return NetworkInfoFromJSONTyped(json, false);
}
export function NetworkInfoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NetworkInfoToJSON(json) {
    return NetworkInfoToJSONTyped(json, false);
}
export function NetworkInfoToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
