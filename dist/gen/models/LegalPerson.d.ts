 ...
 */
export declare function instanceOfLegalPerson(value: object): value is LegalPerson;
export declare function LegalPersonFromJSON(json: any): LegalPerson;
export declare function LegalPersonFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegalPerson;
export declare function LegalPersonToJSON(json: any): LegalPerson;
export declare function LegalPersonToJSONTyped(value?: LegalPerson | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=LegalPerson.d.ts.map