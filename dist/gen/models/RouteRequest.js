 ...
 */
export function instanceOfRouteRequest(value) {
    if (!('amount_in' in value) || value['amount_in'] === undefined)
        return false;
    if (!('dest_asset_chain_id' in value) || value['dest_asset_chain_id'] === undefined)
        return false;
    if (!('dest_asset_denom' in value) || value['dest_asset_denom'] === undefined)
        return false;
    if (!('source_asset_chain_id' in value) || value['source_asset_chain_id'] === undefined)
        return false;
    if (!('source_asset_denom' in value) || value['source_asset_denom'] === undefined)
        return false;
    return true;
}
export function RouteRequestFromJSON(json) {
    return RouteRequestFromJSONTyped(json, false);
}
export function RouteRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RouteRequestToJSON(json) {
    return RouteRequestToJSONTyped(json, false);
}
export function RouteRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
