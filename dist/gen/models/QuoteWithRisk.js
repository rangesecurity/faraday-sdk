 ...
 */
export function instanceOfQuoteWithRisk(value) {
...
export function QuoteWithRiskFromJSON(json) {
    return QuoteWithRiskFromJSONTyped(json, false);
}
export function QuoteWithRiskFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function QuoteWithRiskToJSON(json) {
    return QuoteWithRiskToJSONTyped(json, false);
}
export function QuoteWithRiskToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
