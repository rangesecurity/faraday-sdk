 ...
 */
export function instanceOfSubmitTransactionRequest(value) {
...
export function SubmitTransactionRequestFromJSON(json) {
    return SubmitTransactionRequestFromJSONTyped(json, false);
}
export function SubmitTransactionRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmitTransactionRequestToJSON(json) {
    return SubmitTransactionRequestToJSONTyped(json, false);
}
export function SubmitTransactionRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
