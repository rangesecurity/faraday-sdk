 ...
 */
export declare function instanceOfQuoteWithRisk(value: object): value is QuoteWithRisk;
export declare function QuoteWithRiskFromJSON(json: any): QuoteWithRisk;
export declare function QuoteWithRiskFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuoteWithRisk;
export declare function QuoteWithRiskToJSON(json: any): QuoteWithRisk;
export declare function QuoteWithRiskToJSONTyped(value?: QuoteWithRisk | null, ignoreDiscriminator?: boolean): any;
//# sourceMappingURL=QuoteWithRisk.d.ts.map