...
export interface ListTokensByNetworkRequest {
    network: Network;
}
...
export class TokensApi extends runtime.BaseAPI {
     ...
     */
    async listTokensRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TokenMeta>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(TokenMetaFromJSON));
    }

    /**
     * Get Faraday supported tokens
     */
    async listTokens(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TokenMeta>> {
        const response = await this.listTokensRaw(initOverrides);
        return await response.value();
    }

    /**
     * Get Faraday supported tokens by network
     */
    async listTokensByNetworkRaw(requestParameters: ListTokensByNetworkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TokenMeta>>> {
        if (requestParameters['network'] == null) {
            throw new runtime.RequiredError(
                'network',
                'Required parameter "network" was null or undefined when calling listTokensByNetwork().'
            );
        }
     ...
     * Get Faraday supported tokens by network
     */
    async listTokensByNetwork(requestParameters: ListTokensByNetworkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TokenMeta>> {
        const response = await this.listTokensByNetworkRaw(requestParameters, initOverrides);
        return await response.value();
    }
