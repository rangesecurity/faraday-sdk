 ...
 */
export function instanceOfNaturalPerson(value: object): value is NaturalPerson {
    return true;
}

export function NaturalPersonFromJSON(json: any): NaturalPerson {
    return NaturalPersonFromJSONTyped(json, false);
}

export function NaturalPersonFromJSONTyped(json: any, ignoreDiscriminator: boolean): NaturalPerson {
    if (json == null) {
        return json;
    }
    return {
...
export function NaturalPersonToJSON(json: any): NaturalPerson {
    return NaturalPersonToJSONTyped(json, false);
}

export function NaturalPersonToJSONTyped(value?: NaturalPerson | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
