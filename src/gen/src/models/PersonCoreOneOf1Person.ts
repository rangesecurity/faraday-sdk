 ...
 */
export function instanceOfPersonCoreOneOf1Person(value: object): value is PersonCoreOneOf1Person {
    return true;
}

export function PersonCoreOneOf1PersonFromJSON(json: any): PersonCoreOneOf1Person {
    return PersonCoreOneOf1PersonFromJSONTyped(json, false);
}

export function PersonCoreOneOf1PersonFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonCoreOneOf1Person {
    if (json == null) {
        return json;
    }
    return {
...
export function PersonCoreOneOf1PersonToJSON(json: any): PersonCoreOneOf1Person {
    return PersonCoreOneOf1PersonToJSONTyped(json, false);
}

export function PersonCoreOneOf1PersonToJSONTyped(value?: PersonCoreOneOf1Person | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
