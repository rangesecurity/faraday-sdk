...
/**
 * Check if a given object implements the QuoteWithRisk interface.
 */
export function instanceOfQuoteWithRisk(value: object): value is QuoteWithRisk {
    if (!('quote' in value) || value['quote'] === undefined) return false;
    if (!('risk' in value) || value['risk'] === undefined) return false;
    return true;
}

export function QuoteWithRiskFromJSON(json: any): QuoteWithRisk {
    return QuoteWithRiskFromJSONTyped(json, false);
}

export function QuoteWithRiskFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuoteWithRisk {
    if (json == null) {
        return json;
    }
    return {
        
        'quote': RouteQuoteFromJSON(json['quote']),
        'risk': json['risk'],
    };
}

export function QuoteWithRiskToJSON(json: any): QuoteWithRisk {
    return QuoteWithRiskToJSONTyped(json, false);
}

export function QuoteWithRiskToJSONTyped(value?: QuoteWithRisk | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'quote': RouteQuoteToJSON(value['quote']),
        'risk': value['risk'],
    };
}
