 ...
 */
export function instanceOfPersonCoreOneOfPerson(value: object): value is PersonCoreOneOfPerson {
    return true;
}

export function PersonCoreOneOfPersonFromJSON(json: any): PersonCoreOneOfPerson {
    return PersonCoreOneOfPersonFromJSONTyped(json, false);
}

export function PersonCoreOneOfPersonFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonCoreOneOfPerson {
    if (json == null) {
        return json;
    }
    return {
...
export function PersonCoreOneOfPersonToJSON(json: any): PersonCoreOneOfPerson {
    return PersonCoreOneOfPersonToJSONTyped(json, false);
}

export function PersonCoreOneOfPersonToJSONTyped(value?: PersonCoreOneOfPerson | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
