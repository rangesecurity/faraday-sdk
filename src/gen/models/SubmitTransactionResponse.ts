 ...
 */
export function instanceOfSubmitTransactionResponse(value: object): value is SubmitTransactionResponse {
    return true;
}

export function SubmitTransactionResponseFromJSON(json: any): SubmitTransactionResponse {
    return SubmitTransactionResponseFromJSONTyped(json, false);
}

export function SubmitTransactionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmitTransactionResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmitTransactionResponseToJSON(json: any): SubmitTransactionResponse {
    return SubmitTransactionResponseToJSONTyped(json, false);
}

export function SubmitTransactionResponseToJSONTyped(value?: SubmitTransactionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
